# 🏠 AnTrạchHub – Nền Tảng Tư Vấn Phong Thủy & Pháp Phẩm Kim Cang Thừa  
...
Chức năng ước tính chi phí xây dựng dựa trên:
...
- Gợi ý tiết kiệm / tối ưu chi phí  

---

# 7️⃣ XEM LỊCH ÂM DƯƠNG (Can Chi – Giờ Hoàng Đạo)
...
Hệ thống AnTrạchHub được thiết kế theo mô hình **đa tầng – đa module**, đảm bảo dễ mở rộng, dễ bảo trì và chuẩn theo kiến trúc WordPress hiện đại.

css
Sao chép mã
  ┌──────────────────────────────────────────┐
  │                 CLIENT UI                 │
  │ (Theme WordPress + CSS + JS + Shortcodes) │
  └──────────────────────────────────────────┘
                       │
                       ▼
  ┌──────────────────────────────────────────┐
  ...
  │  - Tính toán hướng                       │
  │  - Xác định cung phi                     │
  │  - Lỗ Ban / Lịch âm / Dự toán xây nhà    │
  └──────────────────────────────────────────┘
                       │
                       ▼
  ┌──────────────────────────────────────────┐
  ...
  │  - Bảng Can Chi                           │
  │  - Bảng Thước Lỗ Ban                      │
  │  - Bảng quy chiếu phong thủy              │
  └──────────────────────────────────────────┘
                       │
                       ▼
  ┌──────────────────────────────────────────┐
  │        WOOCOMMERCE (ECOMMERCE)           │
  │  - Pháp phẩm Kim Cang Thừa                │
  │  - Giỏ hàng / Thanh toán                  │
  │  - Gợi ý sản phẩm hợp mệnh                │
  └──────────────────────────────────────────┘
...
## **1. Giao diện người dùng (Client – Frontend)**

Sử dụng:

- HTML5 + PHP Template của WordPress  
- CSS3 tùy chỉnh  
- JavaScript thuần hoặc kết hợp jQuery  
- Các bảng hiển thị phong thủy thiết kế theo **card layout**  
- Biểu đồ – thước – hướng sử dụng canvas hoặc div mô phỏng  

Frontend nhận dữ liệu từ:
...
## **2. Tầng Plugin (Core Logic)**

Phần quan trọng nhất của hệ thống.

Mỗi chức năng phong thủy được đóng gói thành **một plugin độc lập**, gồm:
...
Tầng này xử lý tất cả:

✔ Tính cung phi  
✔ Bát Trạch Minh Cảnh  
✔ Kim Lâu – Hoang Ốc – Tam Tai – Trạch Tuổi  
✔ Tính toán lịch âm dương  
✔ Giờ hoàng đạo – hắc đạo  
✔ Hàm chuyển đổi Can Chi  
✔ Chuyển đổi đơn vị thước Lỗ Ban  
✔ Dự toán xây nhà  
✔ Gợi ý pháp phẩm  
